...
Future<MultipartRequest> getMultiPartRequest(String endPoint, {String? baseUrl}) async {
  print("API_CALL_DETECTED::::ENDPOINT->${endPoint}");
...
Future sendMultiPartRequest(MultipartRequest multiPartRequest, {Function(dynamic)? onSuccess, Function(dynamic)? onError}) async {
  // print("API_CALL_DETECTED::::sendMultiPartRequest->${multiPartRequest.url}");
  // print("API_CALL_DETECTED::::sendMultiPartRequest-Field->${multiPartRequest.fields}");
  // print("API_CALL_DETECTED::::sendMultiPartRequest-Files->${multiPartRequest.files.first.filename}");
  multiPartRequest.headers.addAll(buildHeaderTokens());

  await multiPartRequest.send().then((res) {
    // print("API_CALL_DETECTED::::sendMultiPartRequest-StatusCode->${res.statusCode}");
    if(res.statusCode==200){
      res.stream.transform(Utf8Decoder()).transform(LineSplitter()).listen((value) {
        // print("API_CALL_DETECTED::::sendMultiPartRequest-response->${value}");
